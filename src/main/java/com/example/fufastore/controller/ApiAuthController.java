...
public class ApiAuthController {
    ...
    // } else {
    // return ResponseUtil.generateErrorResponse("Loggin failed", "Email or password
    // doesnt match");
    // }
    // } else {
    // return ResponseUtil.generateErrorResponse("Loggin failed", "Email or password
    ...
    public ResponseEntity<ApiResponse<Object>> login(@RequestBody Map<String, String> request,
        ...
        try {
            ...
            return ResponseUtil.generateSuccessResponseWithHeaders("Loggin Success", null, headers);
        } catch (Exception e) {
